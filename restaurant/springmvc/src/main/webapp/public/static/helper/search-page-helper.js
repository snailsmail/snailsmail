$(function () {
  ...
  $.fn.extend({
     ...
     */
    initSearchResultTable: function (boxName, menus, _sorts_, _page_, currentURI, colOrderArrangable, colResizable) {
      ...
      var rowOpiton = boxName ? { inputName: boxName } : { showSelectAll: false };
      $(this).semiAutoTable({
        ...
        menuBarWrapperClass: "col-sm-12 col-md-9 semi-auto-table-menubar",
        paginatorWrapperClass: "col-sm-12 col-md-3 semi-auto-table-paginator",
      })
