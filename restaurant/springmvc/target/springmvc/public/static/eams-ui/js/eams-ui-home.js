...
$(function() {
  ...
  var changeBg = function(bg) {
    for (var i = 1; i <= 10; i++) {
      $body.removeClass('e-home-bg' + i);
    }
    $body.addClass('e-home-bg' + bg);
  }
  //
  // 切换背景图片
  // ------------------------------------------------
  $("#e-theme-button-bg1").click(function() {
    changeBg('1');
  });
  $("#e-theme-button-bg2").click(function() {
    changeBg('2');
  });
  $("#e-theme-button-bg3").click(function() {
    changeBg('3');
  });
  $("#e-theme-button-bg4").click(function() {
    changeBg('4');
  });
  $("#e-theme-button-bg5").click(function() {
    changeBg('5');
  });
  $("#e-theme-button-bg6").click(function() {
    changeBg('6');
  });
  $("#e-theme-button-bg7").click(function() {
    changeBg('7');
  });
  $("#e-theme-button-bg8").click(function() {
    changeBg('8');
  });
  $("#e-theme-button-bg9").click(function() {
    changeBg('9');
  });
  $("#e-theme-button-bg10").click(function() {
    changeBg('10');
  });
